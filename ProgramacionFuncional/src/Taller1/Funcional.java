...
public class Funcional {
	...
	public static void main(String[] args) {
		...
		/*
		 * Como vemos, en este paradigma de programación apenas escribimos líneas de código, además de que constantemente
		 * realizamos llamadas a funciones que realizan las instrucciones por nosotros en vez de tener que definirlas
		 * nosotros mismos.
		 */
